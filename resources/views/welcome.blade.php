			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="{{asset('images\logo.png')}}" class="brand_logo" alt="Logo" style="width: 150px; border-radius:150px;">
					</div>
				</div>
				<div class="d-flex justify-content-center form_container">
					<form action="{{ route('login')}}" method="post"> 
						...
						<div class="input-group mb-3">
							...
							<input type="text" name="email" class="form-control input_user" value="" placeholder="Correo electronico">
						</div>
				...
				<div class="mt-4">
					<div class="d-flex justify-content-center links">
						¿No tienes una cuenta? <a href="register" class="ml-2">Registrate</a>
					</div>
					<div class="d-flex justify-content-center links">
